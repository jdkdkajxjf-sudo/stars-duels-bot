...
async function main() {
  ...
  await altgram.setMyCommands([
    ...
    { command: 'pending', description: '[админ] Pending заявки на вывод' },
    { command: 'approve', description: '[админ] Одобрить вывод: /approve <id>' },
    { command: 'reject', description: '[админ] Отклонить вывод: /reject <id>' },
